...
class MerchantService {
  Future<List<Merchant>> getPlaceList() async {
    final result = await dioObject.get('https://wgs0z4xv93.execute-api.ap-northeast-2.amazonaws.com/Prod/merchants',
  ...
  Future<Merchant?> getPlace(String id) async {
    final result = await dioObject.get('https://wgs0z4xv93.execute-api.ap-northeast-2.amazonaws.com/Prod/merchant/id/$id',
      options: Options(responseType: ResponseType.json),);
